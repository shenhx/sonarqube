...
public class UpdateActionTest {
  ...
  WsActionTester ws = new WsActionTester(new UpdateAction(dbClient, userSession));
  ...
  public void remove_existing_settings_when_no_value_sent() throws Exception {
    setUserAsSystemAdmin();
    propertyDb.insertProperty(newGlobalPropertyDto("email.smtp_host.secured", "smtp.gmail.com"));
    propertyDb.insertProperty(newGlobalPropertyDto("email.smtp_port.secured", "25"));
    propertyDb.insertProperty(newGlobalPropertyDto("email.smtp_secure_connection.secured", "starttls"));
    propertyDb.insertProperty(newGlobalPropertyDto("email.smtp_username.secured", "john"));
    propertyDb.insertProperty(newGlobalPropertyDto("email.smtp_password.secured", "12345"));
    propertyDb.insertProperty(newGlobalPropertyDto("email.from", "noreply@email.com"));
    propertyDb.insertProperty(newGlobalPropertyDto("email.prefix", "[EMAIL]"));
