...
public class TestAction implements EmailsWsAction {
  ...
  public TestAction(UserSession userSession, EmailNotificationChannel emailNotificationChannel) {
  ...
  public void define(WebService.NewController context) {
    WebService.NewAction action = context.createAction("test")
      .setDescription("Test email settings<br>" +
